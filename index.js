...
const AUDR_ZONES = {
  MARILIA: [
    ...
    'PARA DAR ENTRADA','PROTOCOLADO ADM','PROTOCOLADO',
    'AUXILIO INCAPACIDADE','PROCESSO COM GUARDA BPC',
    'PERICIAS MARCADAS','EM ANALISE PERICIAS FEITAS',
    'SALARIO MATERNIDADE GUIA PAGA',
    'SALARIO MATERNIDADE 5 7 MESES','SALARIO MATERNIDADE 3 5 MESES',
    'SALARIO MATERNIDADE 1 A 3 MESES','SALARIO MATERNIDADE'
  ],
  LETICIA_OU_ALICE: [
  ...
  TAMMYRES: [
    'FALTA LAUDO FAZER PREVDOC','FALTA LAUDO','PREVDOC'
  ],
  EDUARDO: [
    'TRABALHISTA'
  ]
